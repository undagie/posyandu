...
<h4><p align="center">LAPORAN RIWAYAT IMUNISASI BAYI</p></h4>
<body>
<table border="1" align="center" class="table1">
    <tr>
        ...
        <?php $no = 1; foreach ($data as $key):?>
            ...
            <td><?php echo $no++?></td>
            <td><?php echo tgl_indo($key->jadwal_imunisasi)?></td>
            <td><?php echo $key->petugas ?></td>
            <td><?php echo $key->nama_bayi ?></td>
            <td><?php echo $key->tempat_posyandu ?></td>
            <td><?php echo $key->berat_badan ?></td>
            <td><?php echo $key->panjang_badan ?></td>
            <td><?php echo $key->lingkar_kepala ?></td>
            <td><?php echo $key->lingkar_tangan ?></td>
            <td><?php echo $key->pemberian_obat ?></td>
            <td><?php echo $key->dosis ?></td>
            <td><?php echo $key->catatan_petugas ?></td>
