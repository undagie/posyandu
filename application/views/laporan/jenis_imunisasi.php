...
<div class="page-wrapper">
    	<div class="container-fluid">
        	<div class="row page-titles">
					...
					Laporan Data Jenis Imunisasi
					</h4>
				<br>
				<div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_jenis_imunisasi') ?>" method="post" target="_blank">
						<div class="input-group ">
                    		
							<button type="button" style="font-weight: bold; background-color: #000000; color: #fff;" class="btn">Usia</button>
						 
							<select name="filter" required class="form-control col-md-4">
							<option value="">Pilih Usia</option>
							<option value="semua">Semua</option>
							<?php
								$tes = $this->db->query("SELECT * from jenis_imunisasi group by usia")->result();
							?>
							<?php foreach ( $tes as $i) : ?>
							<option value="<?php echo $i->usia;?>"><?php echo $i->usia;?></option>
							<?php endforeach; ?>
