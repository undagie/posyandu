...
<div class="page-wrapper">
    	<div class="container-fluid">
        	<div class="row page-titles">
					...
					Laporan Daftar Pemeriksaan Ibu Hamil
					</h4>
				<br>
				<br>
            <div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_daftar_pemeriksaan') ?>" method="post" target="_blank">
					<div class="input-group ">
							...
							<?php
								$tes = $this->db->query("SELECT * from pemeriksaan group by tempat_posyandu")->result();
							?>
							<?php foreach ( $tes as $i) : ?>
							<option value="<?php echo $i->tempat_posyandu;?>"><?php echo $i->tempat_posyandu;?></option>
							<?php endforeach; ?>
							</select>
