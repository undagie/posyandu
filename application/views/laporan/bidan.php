    	...
    	<div class="container-fluid">
        	<div class="row page-titles">
				...
				<div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_bidan') ?>" method="post" target="_blank">
						<div class="input-group ">
							...
							<?php
								$tes = $this->db->query("SELECT * from pegawai where role = 'bidan' group by unit_posyandu")->result();
							?>
