    	...
    	<div class="container-fluid">
        	<div class="row page-titles">
				...
				<div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_posyandu') ?>" method="post" target="_blank">
						<div class="input-group ">
                    		
							<button type="button" style="font-weight: bold; background-color: #000000; color: #fff;" class="btn">Nama Posyandu</button>
						 
							<select name="filter" required class="form-control col-md-4">
							<option value="">Pilih Nama Posyandu</option>
							<option value="semua">Semua</option>
							<?php
									$tes = $this->db->query("SELECT * from posyandu")->result();
							?>
							<?php foreach ( $tes as $i) : ?>
							<option value="<?php echo $i->nama_posyandu;?>"><?php echo $i->nama_posyandu;?></option>
							<?php endforeach; ?>
							</select>
