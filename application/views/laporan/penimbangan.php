...
<div class="page-wrapper">
    	<div class="container-fluid">
        	<div class="row page-titles">
					...
					Laporan Riwayat Penimbangan Balita
					</h4>
				<br>
				<br>
            <div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_penimbangan') ?>" method="post" target="_blank">
					<div class="input-group ">
							...
							<?php
								$tes = $this->db->query("SELECT * from hasil_penimbangan group by nama_bayi")->result();
							?>
