...
<div class="page-wrapper">
    	<div class="container-fluid">
            ...
            <div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_pemeriksaan') ?>" method="post" target="_blank">
					<div class="input-group ">
            				...
            				<button type="button" style=" font-weight: bold; background-color: #000000; color: #fff;" class="btn">Nama</button>
							<select name="filter" required class="form-control col-md-4">
							<option value="">Pilih</option>
							<option value="semua">Semua</option>
							<?php
								$tes = $this->db->query("SELECT * from pemeriksaan group by nama")->result();
							?>
