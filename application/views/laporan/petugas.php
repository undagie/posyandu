    	...
    	<div class="container-fluid">
        	<div class="row page-titles">
				...
				<div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_petugas') ?>" method="post" target="_blank">
						<div class="input-group ">
							...
							<?php
								$tes = $this->db->query("SELECT * from pegawai where role = 'petugas' group by unit_posyandu")->result();
							?>
							<?php foreach ( $tes as $i) : ?>
							<option value="<?php echo $i->unit_posyandu;?>"><?php echo $i->unit_posyandu;?></option>
							<?php endforeach; ?>
							</select>
