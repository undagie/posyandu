...
<!-- batas modal -->
  ...
  <!-- modal -->
<div id="jadwalPemeriksaan2" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="width:1000px; margin-left: -150px;">
      ...
      <div class="modal-body">
                        <table id="pempol12" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Posyandu</th>
                            ...
                            <td><?php echo $key->alamat ?></td>
                              ...
                              <td><button class="jadwalPemeriksaan2"
...
<script>
   $(document).on('click', '.jadwalPemeriksaan2', function (e) {
        document.getElementById("tempat_posyandu").value = $(this).attr('data-nim1');

        $('#jadwalPemeriksaan2').modal('hide');
       });
</script>
<!-- batas modal -->

  <!-- modal -->
<div id="jadwalPeriksa" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <div class="modal-content" style="width:1000px; margin-left: -150px;">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Ambil Data Jadwal Pemeriksaan Ibu Hamil</h4>
      </div>
      <div class="modal-body">
                        <table id="pempol13" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tanggal</th>
                            ...
                            <td><?php echo $key->tempat ?></td>
                              ...
                              <td><button class="jadwalPeriksa"
                              
                               data-nim1="<?php echo $key->tanggal ?>"
                               data-nim2="<?php echo $key->pukul ?>"
                               data-nim3="<?php echo $key->rt ?>"
                               data-nim4="<?php echo $key->tempat ?>"
...
<script>
   $(document).on('click', '.jadwalPeriksa', function (e) {
        document.getElementById("jadwal_pemeriksaan").value = $(this).attr('data-nim1');
        document.getElementById("field-pukul").value = $(this).attr('data-nim2');
        document.getElementById("field-rt").value = $(this).attr('data-nim3');
        document.getElementById("field-tempat_posyandu").value = $(this).attr('data-nim4');

        $('#jadwalPeriksa').modal('hide');
       });
</script>
<!-- batas modal -->

  <!-- modal -->
<div id="jadwalPeriksa2" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="width:1000px; margin-left: -150px;">
      ...
      <div class="modal-body">
                        <table id="pempol14" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tanggal</th>
                            ...
                            <td><?php echo $key->tempat ?></td>
                              ...
                              <td><button class="jadwalPeriksa2"
...
<script>
   $(document).on('click', '.jadwalPeriksa2', function (e) {
        document.getElementById("jadwal_penimbangan").value = $(this).attr('data-nim1');
        document.getElementById("pukul").value = $(this).attr('data-nim2');
        document.getElementById("rt").value = $(this).attr('data-nim3');
        document.getElementById("tempat_posyandu").value = $(this).attr('data-nim4');

        $('#jadwalPeriksa2').modal('hide');
       });
</script>
<!-- batas modal -->

  <!-- modal -->
<div id="jadwalImun" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="width:1000px; margin-left: -150px;">
      ...
      <div class="modal-body">
                        <table id="pempol15" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tanggal</th>
                            ...
                            <?php
                            $no = 1;
                            $data = $this->db->query(" SELECT * FROM jadwal_imunisasi ORDER BY id ASC")->result();
                             foreach ($data as $key): ?>
                            <tr>
                            <td><?php echo $no++?></td>
                            <td><?php echo $key->tanggal ?></td>
...
<script>
   $(document).on('click', '.jadwalImun', function (e) {
        document.getElementById("jadwal_imunisasi").value = $(this).attr('data-nim1');
        document.getElementById("field-pukul").value = $(this).attr('data-nim2');
        document.getElementById("field-rt").value = $(this).attr('data-nim3');
        document.getElementById("field-tempat_posyandu").value = $(this).attr('data-nim4');

        $('#jadwalImun').modal('hide');
       });
</script>
<!-- batas modal -->
